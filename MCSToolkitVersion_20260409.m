...
%MaxInterval are top two but which should we use?
...
OptionalAnalysis = AnalysisCatalog_20260211();
...
for z = 1:nFiles
    ...
    clear nWindows Idxpeak i ii j SpikeIdx AfterEventMs BeforeEventMs
    ...
    clear MinDuration MaxInterBurstInterval
    ...
    clear nNetworkBurstingElectrodes nNetworkElectrodesInvolved
