...
function Catalog = AnalysisCatalog_20250911()
Catalog = [
    MakeNode('STTC','STTC_NullDistribution_20250911', [ ...
    MakeNode('STTC Visualization','STTC_Visualization',[]), ...   %Temp fake for visualization
    MakeNode('STTC Exports','STTC_ExportCSV',[]) ...
    ]), ...
    MakeNode('Clustering','ClusteringCoefficient_20250911', [])
    ];
end
