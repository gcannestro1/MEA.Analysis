...
% Expects FilteredTable with  WellNumber, Electrode1, Electrode2, STTC
    ...
    for j = 1:numel(UniqueWellsSTTC)
        ...
        axis equal tight
        colormap(jet);                       % use any colormap you like
        ...
        exportgraphics(gcf, PngFile, 'Resolution', 600, Units="pixels", Width = 600,Height = 600, Padding =10)
        close(f)
    end
